...
const PsychotraumatologyContent = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-[calc(100dvh-4rem)] sm:min-h-[calc(100dvh-5rem)] w-full flex flex-col items-center justify-center overflow-hidden">
        {/* Background Image with overlay for readability */}
        <div className="absolute w-full h-[calc(100dvh-4rem)] sm:h-[calc(100dvh-5rem)] -z-10">
          <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <p className="text-neutral-700 text-lg leading-relaxed">
                ...
                leczeniem osób z objawami stresu pourazowego. Zrozumienie tego,
                jak mózg i ciało przetwarzają sytuacje traumatyczne, jest
...
export default PsychotraumatologyContent;
